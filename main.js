...
if(window.localStorage.getItem('myLocalTasks') === null){
    window.localStorage.setItem('myLocalTasks', '{"myDay":{"completed":[],"uncompleted":["Type task to [Add to task] fied and press [Enter]","[Completed] shows all your completed tasks","[All Tasks] shows all your uncomplete tasks","Tap all the circles in this list to complete your tasks ✔️","🖱️ Click this task to view and edit information in content field ✏️","👉 Select this task and click 🗑️ in the right bottom corner to delete it"]},"important":{"completed":["This is an important panel's completed task"],"uncompleted":["This is an important panel's incomplete task"]},"assignToMe":{"completed":["Assign to me panel's completed task"],"uncompleted":["Assign to me panel's incomplete task"]},"planned":{"completed":["Planned completed task"],"uncompleted":["Planned incompleted task"]},"groceries":{"completed":[],"uncompleted":["Milk 🍼","Bread 🍞","Eggs 🥚","Fruit & Vegetables 🥕"]},"work":{"completed":[],"uncompleted":["Task at work ..."]},"school":{"completed":[],"uncompleted":["Task at school"]},"family":{"completed":[],"uncompleted":["For family ❤️‍🔥"]}}');
}
